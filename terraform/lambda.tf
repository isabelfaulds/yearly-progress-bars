...
resource "aws_lambda_permission" "allow_apigateway_invocation" {
  ...
  source_arn    = "arn:aws:execute-api:us-west-1:***REMOVED***:vae1x9x8se/*/POST/users_auth"
}
...
resource "aws_lambda_permission" "allow_apigateway_invocation_invalidation" {
  ...
  principal     = "apigateway.amazonaws.com"
  source_arn    = "arn:aws:execute-api:us-west-1:***REMOVED***:vae1x9x8se/*/POST/users_auth/logout"
}
...
resource "aws_lambda_permission" "allow_apigateway_invocation_refresh" {
  ...
  principal     = "apigateway.amazonaws.com"
  source_arn    = "arn:aws:execute-api:us-west-1:***REMOVED***:vae1x9x8se/*/POST/users_auth/refresh"
}
