...
# #### spi gateway authorizer

# resource "aws_api_gateway_authorizer" "token_authorizer" {
#   name            = "TokenAuthorizer"
#   rest_api_id     = aws_api_gateway_rest_api.your_api.id # Replace with your API Gateway ID
#   authorizer_uri  = "arn:aws:lambda:us-west-1:${data.aws_caller_identity.current.account_id}:function:node-auth-token-authorizer" 
#   type            = "TOKEN"
#   identity_source = "method.request.header.Authorization" # Or other source (e.g., query string)

#   # Optional settings:
#   authorizer_credentials = aws_iam_role.api_gateway_authorizer_role.arn # If you need credentials
#   authorizer_result_ttl_in_seconds = 300 # Token caching TTL
# }
